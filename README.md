Floppy Bird
=========
Initially, I wanted to try recreating flappy cristi in HTML5, using a canvas and recycling the assets from the old game.
...
Notice
=====
The assets powering the visual element of the game have all been extracted directly from the flappy cristi android game. I have only done the coding, not designed the visual elements.  
